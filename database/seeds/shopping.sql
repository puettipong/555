...
-- Dumping structure for table shopping.amphures
...
-- Dumping data for table shopping.amphures: 998 rows
/*!40000 ALTER TABLE `amphures` DISABLE KEYS */;
REPLACE INTO `amphures` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
-- Dumping data for table shopping.carts: ~0 rows (approximately)
...
-- Dumping data for table shopping.categories: ~3 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
REPLACE INTO `categories` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'ตุ๊กตา', '2019-10-28 03:42:04', '2019-10-28 03:42:04'),
	(2, 'หมอน', '2019-10-28 03:42:11', '2019-10-28 03:42:12'),
	(3, 'พวงกุญแจ', '2019-10-28 03:42:22', '2019-10-28 03:42:22');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Dumping structure for table shopping.districts
...
-- Dumping data for table shopping.districts: 8,849 rows
/*!40000 ALTER TABLE `districts` DISABLE KEYS */;
REPLACE INTO `districts` (`id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
-- Dumping structure for table shopping.failed_jobs
...
-- Dumping data for table shopping.failed_jobs: ~0 rows (approximately)
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Dumping structure for table shopping.geographies
...
-- Dumping data for table shopping.geographies: 6 rows
/*!40000 ALTER TABLE `geographies` DISABLE KEYS */;
REPLACE INTO `geographies` (`id`, `name`) VALUES
	(1, 'ภาคเหนือ'),
	(2, 'ภาคกลาง'),
...
-- Dumping structure for table shopping.members
...
-- Dumping data for table shopping.members: ~0 rows (approximately)
...
-- Dumping data for table shopping.migrations: ~14 rows (approximately)
/*!40000 ALTER TABLE `migrations` DISABLE KEYS */;
REPLACE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '2014_10_12_000000_create_users_table', 1),
	(2, '2014_10_12_100000_create_password_resets_table', 1),
	(3, '2019_08_19_000000_create_failed_jobs_table', 1),
	(4, '2019_10_07_144826_create_products_table', 1),
	(5, '2019_10_07_193332_create_members_table', 1),
	(6, '2019_10_14_123555_create_carts_table', 1),
	(7, '2019_10_15_002235_create_categories_table', 1),
	(8, '2019_10_15_201330_create_my_accounts_table', 1),
	(9, '2019_10_17_202430_add_userrole_to_users_table', 1),
	(10, '2019_10_19_013936_create_permission_tables', 1),
	(11, '2019_10_22_015045_create_orders', 1),
	(12, '2019_10_22_015108_create_order_items', 1),
	(13, '2019_10_24_165850_create_post_addresses_table', 1),
	(14, '2019_10_28_121344_create_transactions_table', 1);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;

-- Dumping structure for table shopping.model_has_permissions
...
-- Dumping data for table shopping.model_has_permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `model_has_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `model_has_permissions` ENABLE KEYS */;

-- Dumping structure for table shopping.model_has_roles
...
-- Dumping data for table shopping.model_has_roles: ~2 rows (approximately)
...
-- Dumping structure for table shopping.my_accounts
CREATE TABLE IF NOT EXISTS `my_accounts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `my_accounts_user_id_foreign` (`user_id`),
  CONSTRAINT `my_accounts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table shopping.my_accounts: ~0 rows (approximately)
...
-- Dumping data for table shopping.orders: ~2 rows (approximately)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;

-- Dumping structure for table shopping.order_items
...
-- Dumping data for table shopping.order_items: ~2 rows (approximately)
...
-- Dumping structure for table shopping.permissions
...
-- Dumping data for table shopping.permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `permissions` ENABLE KEYS */;

-- Dumping structure for table shopping.post_addresses
CREATE TABLE IF NOT EXISTS `post_addresses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `post_addresses_user_id_foreign` (`user_id`),
  CONSTRAINT `post_addresses_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table shopping.post_addresses: ~0 rows (approximately)
/*!40000 ALTER TABLE `post_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `post_addresses` ENABLE KEYS */;

-- Dumping structure for table shopping.products
CREATE TABLE IF NOT EXISTS `products` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `product_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `detail_1` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table shopping.products: ~38 rows (approximately)
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
REPLACE INTO `products` (`id`, `product_name`, `detail_1`, `price`, `category_id`, `instock`, `add_product`, `picture`, `quantity`, `weight`, `size`, `created_at`, `updated_at`) VALUES
	(1, 'ตุ๊กตาหมา เรนคุง (นอน)', 'ตุ๊กตาหมา เรนคุง มีนิสัยเป็น หมาน้อยขี้เล่น ลักษณะตัวเรนคุงคล้ายข้าวปั่นญี่ปุ่น มีเพื่อนชื่อหมีเฟรนด์', 295.00, 1, 32, 2, '3.jpg', 1, 0.7, 10, '2019-10-28 03:43:21', '2019-11-04 16:34:50'),
	(2, 'ตุ๊กตาหมา เรนคุง (นั่ง)', 'ตุ๊กตาหมา เรนคุง มีนิสัยเป็น หมาน้อยขี้เล่น ลักษณะตัวเรนคุงคล้ายข้าวปั่นญี่ปุ่น มีเพื่อนชื่อหมีเฟรนด์', 295.00, 1, 59, 50, '4.jpg', 1, 0.7, 10, '2019-10-28 03:44:25', '2019-11-04 03:57:50'),
	(3, 'ตุ๊กตาหมา เรนคุง (ยืน)', 'ตุ๊กตาหมา เรนคุง มีนิสัยเป็น หมาน้อยขี้เล่น ลักษณะตัวเรนคุงคล้ายข้าวปั่นญี่ปุ่น มีเพื่อนชื่อหมีเฟรนด์', 295.00, 1, 19, 19, '7.jpg', 1, 0.7, 10, '2019-10-28 03:45:10', '2019-10-28 03:45:10'),
	(4, 'พวงกุญแจ ชิบะโมโม่', 'พวงกุญแจน้องชิบะโมโม่ น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีน้ำตาล ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 15, 15, '5.jpg', 1, 0.5, 5, '2019-10-28 03:46:32', '2019-10-28 03:46:32'),
	(5, 'พวงกุญแจ สุนัขสีหวาน', 'พวงกุญแจน้องสุนัขสีหวาน น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีฟ้า ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 20, 20, '8.jpg', 1, 0.5, 5, '2019-10-28 03:47:27', '2019-10-28 03:47:27'),
	(6, 'หมอนรองคอ โค้งเม็ดโฟม กระต่ายฟรุ๊ตตี้', 'หมอนรองคอ โค้งเม็ดโฟม กระต่ายฟรุ๊ตตี้ ตัวหมอนมีกนิ่มมากกก นอนหลับสบาย ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม ไม่มีเอ้าท์', 250.00, 2, 50, 33, '6.jpg', 1, 0.9, 12, '2019-10-28 03:48:52', '2019-11-04 03:56:42'),
	(7, 'ตุ๊กตา บลูเทอเรียหมอบ', 'ตุ๊กตา บลูเทอเรียหมอบ เป็นตุ๊กตา ตัวหมอบที่น่ารักมาก มีเอกลักษณ์คือ เจ้าบลูเทอเรียตัวนี้ขี้เกียจมาก เพราะหมอบอยู่ตลอดเวลานั่นเอง', 420.00, 1, 50, 50, '9.jpg', 1, 0.7, 10, '2019-11-03 08:19:07', '2019-11-03 08:21:10'),
	(8, 'ตุ๊กตา ลิงจั๊คหมอบ', 'ตุ๊กตา ลิงจั๊คหมอบ เป็นตุ๊กตา ตัวหมอบที่น่ารักมาก มีเอกลักษณ์คือ เจ้าลิงตัวนี้ขี้เกียจมาก เพราะหมอบอยู่ตลอดเวลานั่นเอง', 420.00, 1, 50, 50, '10.jpg', 1, 0.7, 10, '2019-11-03 08:22:28', '2019-11-03 08:24:28'),
	(9, 'ตุ๊กตาหมา ไอซิ่ง นาโนกลิ่นวนิลา', 'ตุ๊กตาหมา ไอซิ่ง เป็นตุ๊กตาคาแร็กเตอร์จาก Rainflowerตุ๊กตาหมา ไอซิ่งเป็นตุ๊กตาใครๆก็ต้องชอบ ยิ่งหน้าร้อนแบบนี้ ต้องชอบมากแน่นอนจ้า', 250.00, 1, 50, 50, '11.jpg', 1, 0.7, 10, '2019-11-03 08:25:38', '2019-11-03 08:26:47'),
	(10, 'ตุ๊กตา วัวหมอบ', 'ตุ๊กตา วัวหมอบ เป็นตุ๊กตา ตัวหมอบที่น่ารักมาก มีเอกลักษณ์คือ เจ้าวัวตัวนี้ขี้เกียจมาก เพราะหมอบอยู่ตลอดเวลานั่นเอง', 420.00, 1, 50, 50, '12.jpg', 1, 0.7, 10, '2019-11-03 08:31:19', '2019-11-03 08:33:49'),
	(11, 'ตุ๊กตาแมว แมวตาโต สีเทา', 'ตุ๊กตาแมว แมวตาโตสีเทา ตุ๊กตาแมว น่ารัก น่ากอด เนื้อผ้านุ่มมากกกก', 350.00, 1, 50, 50, '13.jpg', 1, 0.7, 10, '2019-11-03 08:36:06', '2019-11-03 08:36:49'),
	(15, 'ตุ๊กตาหมา สีฟ้า แก้มโอรส', 'ตุ๊กตาหมา สีฟ้าแก้มโอรส ตุ๊กตาหมา น่ารัก น่ากอด เนื้อผ้านุ่มมากกกก', 350.00, 1, 50, 50, '14.jpg', 1, 0.7, 10, '2019-11-03 08:50:09', '2019-11-03 08:50:09'),
	(16, 'ตุ๊กตาหมา ข้าวเหนียว ตัวกลม ตุ๊กตาขนนุ่ม', 'ตุ๊กตาหมา ข้าวเหนียว ตัวกลม เป็นตุ๊กตาคาแร็กเตอร์จาก Rainflower ตุ๊กตาหมาข้าวเหนียว ตัวกลม น่ารัก น่ากอดสุดสุด', 295.00, 1, 50, 50, '15.jpg', 1, 0.7, 10, '2019-11-03 08:51:00', '2019-11-03 08:51:00'),
	(17, 'พวงกุญแจ แมวสีหวาน', 'พวงกุญแจ แมวสีหวาน น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีโอรส ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '16.jpg', 1, 0.5, 4, '2019-11-04 03:23:33', '2019-11-04 03:23:33'),
	(18, 'พวงกุญแจ โคอาล่า', 'พวงกุญแจ โคอาล่า น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีชมพู ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '17.jpg', 1, 0.5, 4, '2019-11-04 03:24:11', '2019-11-04 03:24:11'),
	(19, 'พวงกุญแจ หมูออมสิน', 'พวงกุญแจ หมูออมสิน น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีชมพู ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '18.jpg', 1, 0.5, 4, '2019-11-04 03:24:55', '2019-11-04 03:24:55'),
	(20, 'พวงกุญแจ แมวน้ำตาล', 'พวงกุญแจ ก้อนสี่เหลี่ยมแบน แมวน้ำตาล พวงกุญแจนุ่มนิ่ม\r\n\r\nน่ารักพวงกุญแจ น่ารัก คอลเล็คชั่นก้อนสี่เหลี่ยม สีน้ำตาล ขนนุ่มนิ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องพวงกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '19.jpg', 1, 0.5, 4, '2019-11-04 03:25:38', '2019-11-04 03:25:38'),
	(21, 'พวงกุญแจ สุนัขโดนัท กลิ่นคาราเมล', 'พวงกุญแจ กลิ่นหอมคาราเมล คอลเล็คชั่น โดนัท สีครีม ขนนุ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องกุญแจก็เก๋ไก๋', 195.00, 3, 50, 50, '20.jpg', 1, 0.5, 4, '2019-11-04 03:26:17', '2019-11-04 03:26:17'),
	(22, 'พวงกุญแจสุนัขเฉาก๊วย Collection ตัวกลม', 'พวงกุญแจสุนัขเฉาก๊วย ตัวกลม สีดำ ขนนุ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '21.jpg', 1, 0.5, 4, '2019-11-04 03:26:54', '2019-11-04 03:26:54'),
	(23, 'พวงกุญแจ แมวแพนเค้ก กลิ่นช็อคโกแลต', 'พวงกุญแจ แมวแพนเค้ก สีขาว กลิ่นหอมช็อคโกแลต  ขนนุ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องกุญแจก็เก๋ไก๋', 115.00, 3, 50, 50, '22.png', 1, 0.5, 4, '2019-11-04 03:28:18', '2019-11-04 03:28:18'),
	(24, 'พวงกุญแจ แมวชีสเค้ก กลิ่นบัตเตอร์', 'พวงกุญแจแมวชีสเค้ก สีขาว กลิ่นหอมบัตเตอร์   ขนนุ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องกุญแจก็เก๋ไก๋', 210.00, 3, 50, 50, '23.png', 1, 0.5, 4, '2019-11-04 03:29:00', '2019-11-04 03:29:00'),
	(25, 'พวงกุญแจ แมวคัพเค้ก กลิ่นสตอเบอร์รี่', 'พวงกุญแจแมวคัพเค้ก สีชมพู กลิ่นหอมช็อคโกแลต  ขนนุ่ม น่ารักน่าใช้ จะเอาไว้ห้อยกระเป๋า หรือคล้องกุญแจก็เก๋ไก๋', 210.00, 3, 50, 50, '24.png', 1, 0.5, 4, '2019-11-04 03:29:48', '2019-11-04 03:29:48'),
	(26, 'หมอนรองคอโค้งฮูด มิลค์เชค', 'หมอนรองคอโค้งฮูด มิลค์เชค ที่จะทำให้คุณมีความเป็นส่วนตัวที่สุด ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี', 430.00, 2, 50, 50, '25.jpg', 1, 0.7, 23, '2019-11-04 03:33:36', '2019-11-04 03:33:36'),
	(27, 'หมอนรองคอ โค้งเม็ดโฟม กบพ็อคกี้', 'หมอนรองคอ โค้งเม็ดโฟม ไก่ชิคชิค ตัวหมอนมีกนิ่มมากกก นอนหลับสบาย ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม ไม่มีเอ้าท์', 430.00, 2, 50, 50, '26.jpg', 1, 0.7, 23, '2019-11-04 03:34:08', '2019-11-04 03:34:08'),
	(28, 'หมอนรองคอ โค้งเม็ดโฟม ไก่ชิคชิค', 'หมอนรองคอ โค้งเม็ดโฟม ไก่ชิคชิค ตัวหมอนมีกนิ่มมากกก นอนหลับสบาย ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม ไม่มีเอ้าท์', 430.00, 2, 50, 50, '27.jpg', 1, 0.7, 23, '2019-11-04 03:34:48', '2019-11-04 03:34:48'),
	(29, 'หมอนรองคอ โค้งเม็ดโฟม แกะลิลลี่', 'หมอนรองคอ โค้งเม็ดโฟม แกะลิลลี่ ตัวหมอนมีกนิ่มมากกก นอนหลับสบาย ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม ไม่มีเอ้าท์', 430.00, 2, 50, 50, '28.jpg', 1, 0.5, 23, '2019-11-04 03:35:27', '2019-11-04 03:35:27'),
	(30, 'หมอนผ้าห่ม หมีฟ้า', 'หมอนผ้าห่ม หมีฟ้า เอาไว้ สอดมือ หนุนหัว ห่ม ผลิตจากวัสดุคุณภาพ เนื้อผ้านุ่ม ไม่ระคายผิว มาพร้อมลวดลายน่ารัก ใครไม่หลงรักก็บ้าแล้ว', 400.00, 2, 50, 50, '29.jpg', 1, 0.7, 23, '2019-11-04 03:36:05', '2019-11-04 03:36:05'),
	(31, 'หมอนผ้าห่ม แมวน้ำตาล', 'หมอนผ้าห่ม แมวน้ำตาล เอาไว้ หนุนหัว ห่ม ผลิตจากวัสดุคุณภาพ เนื้อผ้านุ่ม ไม่ระคายผิว มาพร้อมลวดลายของเจ้าแมวสีน้ำตาล น่ารักมากเวอร์จ้า', 400.00, 2, 50, 50, '30.jpg', 1, 0.7, 23, '2019-11-04 03:36:34', '2019-11-04 03:36:34'),
	(32, 'หมอนผ้าห่ม น้องหมาเทา', 'หมอนผ้าห่ม น้องหมาเทา เอาไว้ หนุนหัว ห่ม ผลิตจากวัสดุคุณภาพ เนื้อผ้านุ่ม ไม่ระคายผิว มาพร้อมลวดลายน่ารัก สีเทา ไม่เลอะเทอะง่าย', 400.00, 2, 50, 50, '31.jpg', 1, 0.7, 23, '2019-11-04 03:37:02', '2019-11-04 03:37:02'),
	(33, 'หมอนผ้าห่ม โคอาล่าชมพู', 'หมอนผ้าห่ม โคอาล่าชมพู เอาไว้ หนุนหัว ห่ม ผลิตจากวัสดุคุณภาพ เนื้อผ้านุ่ม ไม่ระคายผิว มาพร้อมลวดลายน้องหมีโคอาล่าสีชมพู หวานแววสุดสุด', 400.00, 2, 50, 50, '32.jpg', 1, 0.7, 23, '2019-11-04 03:37:35', '2019-11-04 03:37:35'),
	(34, 'หมอนรองคอ แมวสีครีม', 'หมอนรองคอโค้ง แมวสีครีม ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของแมวน่ารักมากเวอร์จ้า', 400.00, 2, 50, 50, '33.jpg', 1, 0.7, 23, '2019-11-04 03:38:16', '2019-11-04 03:38:16'),
	(35, 'หมอนรองคอ แมวสีดำ', 'หมอนรองคอ แมวสีดำ ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของแมวน่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '34.jpg', 1, 0.7, 23, '2019-11-04 03:38:59', '2019-11-04 03:38:59'),
	(36, 'หมอนรองคอ ไดโนเสาร์สีฟ้า', 'หมอนรองคอโค้ง ไดโนเสาร์สีฟ้า ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของไดโนเสาร์น่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '35.jpg', 1, 0.7, 23, '2019-11-04 03:39:34', '2019-11-04 03:39:34'),
	(37, 'หมอนรองคอ แมวสีชมพู', 'หมอนรองคอ แมวสีชมพู ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของแมวน่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '36.jpg', 1, 0.7, 23, '2019-11-04 03:40:24', '2019-11-04 03:40:24'),
	(38, 'หมอนหนุนรองคอ แตงโม', 'หมอนหนุนรองคอ แตงโม ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของกแตงโมน่ารักมากเวอร์จ้า', 395.00, 2, 50, 50, '37.jpg', 1, 0.7, 23, '2019-11-04 03:40:53', '2019-11-04 03:40:53'),
	(39, 'หมอนรองคอเมมโมรี่โฟม แมวครีม', 'หมอนรองคอเมมโมรี่โฟม แมวครีม ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของเจ้าแมวน่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '38.jpg', 1, 0.7, 23, '2019-11-04 03:41:25', '2019-11-04 03:41:25'),
	(40, 'หมอนรองคอเมมโมรี่โฟม หมูชมพู', 'หมอนรองคอเมมโมรี่โฟม หมูชมพู ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของเจ้าหมูอ้วนน่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '39.jpg', 1, 0.7, 23, '2019-11-04 03:41:52', '2019-11-04 03:41:52'),
	(41, 'หมอนรองคอเมมโมรี่โฟม หมีน้ำตาล', 'หมอนรองคอเมมโมรี่โฟม หมีน้ำตาล ตัวหมอนนุ่มนิ่มมากเวอร์  ทำให้ง่ายต่อการพกพา ดีไซน์ตัวหมอนโค้งรับเข้ารูปคอได้พอดี นอนสบายไม่ปวดคอ ไม่ร้อน ระบายอากาศได้ดี น้ำหนักเบา สีสัน ลวดลายน่ารักสวยงาม มาพร้อมกับลวดลายของเจ้าหมูอ้วนน่ารักมากเวอร์จ้า', 265.00, 2, 50, 50, '40.jpg', 1, 0.7, 23, '2019-11-04 03:42:26', '2019-11-04 03:42:26');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;

-- Dumping structure for table shopping.provinces
...
-- Dumping data for table shopping.provinces: 77 rows
/*!40000 ALTER TABLE `provinces` DISABLE KEYS */;
REPLACE INTO `provinces` (`id`, `code`, `name_th`, `name_en`, `geography_id`) VALUES
...
-- Dumping structure for table shopping.roles
...
-- Dumping data for table shopping.roles: ~2 rows (approximately)
/*!40000 ALTER TABLE `roles` DISABLE KEYS */;
REPLACE INTO `roles` (`id`, `name`, `guard_name`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'web', '2019-10-28 03:39:20', '2019-10-28 03:39:21'),
	(2, 'member', 'web', '2019-10-28 03:39:32', '2019-10-28 03:39:33');
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;

-- Dumping structure for table shopping.role_has_permissions
...
-- Dumping data for table shopping.role_has_permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `role_has_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `role_has_permissions` ENABLE KEYS */;

-- Dumping structure for table shopping.transactions
...
-- Dumping data for table shopping.transactions: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `userrole` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'member',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
REPLACE INTO `users` (`id`, `username`, `email`, `email_verified_at`, `password`, `remember_token`, `userrole`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin@a.com', NULL, '$2y$10$wx8ihLPa5xKY5g4wdVHD7ue6RlbvQ2z1fHcOTvHzeGXvso9MmGLRO', NULL, 'admin', '2019-10-28 03:38:16', '2019-11-04 13:59:07'),
	(2, 'member', 'member@m.com', NULL, '$2y$10$a4hzyzBRp7dvb7kiBOeiBuEdJLE3ixfS.OhZC/ulRfjt.CnTKZL0q', NULL, 'member', '2019-10-28 03:38:37', '2019-10-28 03:38:37');
