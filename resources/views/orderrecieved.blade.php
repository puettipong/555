...
<div class="row mt-5">
    <div class="col-md-12" style="border:3px solid orange;padding-top:10px;">
        <p align="center" style="font-size:18px;">Order Number</p>
        <p align="center" style="font-size:18px;">date</p>
        <p align="center" style="font-size:18px;">E-mail</p>
        <p align="center" style="font-size:18px;">รวมทั้งสิ้น</p>
        <p align="center" style="font-size:18px;">วิธีการชำระเงิน</p>
    </div>
</div>
<div class="row mt-5">
    <div class="col-md-12">

        <a href="slipform"><button type="button" class="btn purple-gradient btn-lg btn-block">แจ้งชำระเงิน</button></a>
    </div>
</div>
<div class="row mt-5">
    <div class="col-md-12">
